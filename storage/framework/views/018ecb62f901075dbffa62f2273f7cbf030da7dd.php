...
<!-- Content Wrapper. Contains page content -->
  ...
  <div class="row">
     <div class="col-md-8">
        <h4><strong>Edit Testimonial</strong></h4>
      
    </div>
    <div class="col-md-4">
         <a href="<?php echo e(URL::to('admin/testimonials')); ?>" class="btn btn-success btn-sm pull-right">See All Testimonials</a>
    </div>
  </div>
  ...
  <?php echo e(Form::model($row,array('url'=>['admin/testimonials/edit',$row->id],'enctype' => 'multipart/form-data'))); ?> 
              <div class="box-body">
                ...
                <div class="row">
                      <div class="col-md-6">
                         <div class="form-group">
                          ...
                          <div class="form-group">
                            ...
                            <?php echo e(Form::text('designation', Input::old('designation'), array('placeholder' => 'International Director','class'=>'form-control'))); ?>
                    ...
                    <div class="col-md-6">
                          ...
                          <div class="form-group">
                              ...
                              <?php echo e(Form::text('organization', Input::old('organization'), array('placeholder' => 'Nepal Telecom','class'=>'form-control'))); ?>
