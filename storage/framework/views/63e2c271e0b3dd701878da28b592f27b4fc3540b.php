        ...
        <div id="main-header">
          ...
          <div class="row">
            ...
            <div id="logo" class="col-lg-3 col-md-3 col-sm-3">
              ...
              <a href="<?php echo e(url('')); ?>"><img src="<?php echo e(asset('assets/images/logo.png')); ?>" alt="Serve Now Nepal"></a>
          ...
          <ul id="navigation">
            ...
            <li <?php echo e((Request::is('misc/message-from-chairman','misc/message-from-president','misc/message-from-secretary') ? 'class=current-menu-item' : '')); ?>>
              ...
              <ul>
                ...
                <li><a href="<?php echo e(URL::to('misc',['title'=>'message-from-director'])); ?>">Message from National Director</a></li>                
              </ul>
            ...
            <!-- /Events -->
               ...
               <!--  <li <?php echo e((Request::is('misc/our_history','misc/christian_history') ? 'class=current-menu-item' : '')); ?>><span>History</span>
                 ...
                 <li <?php echo e((Request::is('program/*') ? 'class=current-menu-item': '')); ?>><span>Programs</span>
                 <?php $programs=\DB::table('programs')->orderBy('value', 'desc')->where('published','1')->limit(10)->get();?>
                    <ul>
                    <?php foreach($programs as $program): ?>
                      <li><a href="<?php echo e(URL::to('program',['id'=>$program->id])); ?>"><?php echo e($program->title); ?></a></li>
                    <?php endforeach; ?>
                     <!--  <li><a href="<?php echo e(URL::to('misc',['title'=>'christian_history'])); ?>">Christian Histroy in Nepal</a></li> -->
                    </ul>
                </li>
