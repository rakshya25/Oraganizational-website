...
<div class="blog">
      ...
      <div class="content"> 
        <!-- Begin Post -->
          ...
          <!-- End Post Info -->
           <div class="post-text"> 
           <?php foreach($boards_with_bio as $index=>$board): ?>
              <div class="one-third">
                  <p align="center"><a href="#" title="<?php echo e($board->fullname); ?>"><img src="<?php echo e(asset($board->image)); ?>" width="125" height="155" alt="" /></a>
              </div>
              <div class="one-third-last">
              <p><b><?php echo e($board->fullname); ?></b></p><h5><?php echo e($board->designation); ?></h5></p>
                 <p><?php echo e($board->bio); ?></p>
              </div>
              <div class="clear"></div><br>
            <?php endforeach; ?>
             <hr>
           <?php foreach($boards_without_bio as $index=>$board): ?>
