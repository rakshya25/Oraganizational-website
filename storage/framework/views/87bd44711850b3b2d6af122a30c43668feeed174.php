                    ...
                    <div class="form-group">
                      <label>Title</label>
                        <select name='title' id='select1' class="form-control";>
                          <option value='our-mission' <?php echo e((Input::old("title") == "our-mission" ? "selected":"")); ?>>Our Mission</option> 
                          <option value='our-vision' <?php echo e((Input::old("title") == "our-vision" ? "selected":"")); ?>>Our Vision</option>
                          <option value='our-history' <?php echo e((Input::old("title") == "our-history" ? "selected":"")); ?>>Our History</option>
                          <option value='our-objectives' <?php echo e((Input::old("title") == "our-objectives" ? "selected":"")); ?>>Our Objectives</option> 
                          ...
                          <option value='message-from-secretary' <?php echo e((Input::old("title") == "message-from-secretary" ? "selected":"")); ?>>Message From secretary</option> 
                           ...
                           <option value='the-big-picture' <?php echo e((Input::old("title") == "the-big-picture" ? "selected":"")); ?>>The Big Picture</option> 
                           <option value='join-us' <?php echo e((Input::old("title") == "join-us" ? "selected":"")); ?>>Join Us</option>
                           <option value='career-opportunities' <?php echo e((Input::old("title") == "career-opportunities" ? "selected":"")); ?>>Career Opportunities</option>  
                        </select>
                        </div>
