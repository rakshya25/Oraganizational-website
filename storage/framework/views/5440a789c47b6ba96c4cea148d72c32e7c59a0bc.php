...
<?php echo $__env->make('front.partials.header-top', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
...
<?php echo $__env->make('front.partials.footer', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
    ...
    <!-- Twitter -->
    <script type="text/javascript" src="<?php echo e(asset('assets/php/twitter/jquery.tweet.js')); ?>"></script>
