...
?>                
                ...
                <li>
                  <div class="thumbnail">
                    <img src="<?php echo e(asset($row->thumb)); ?>" alt="">
                  </div>
                  
                  <div class="post-content">
                    <h6><a href="<?php echo e(URL::to('blog',['id'=>$row->id])); ?>"><?php echo e($row->title); ?></a></h6>
                    <div class="post-meta">
                      <small><?php echo e(date("M d, Y", strtotime(substr($row->created_at,0,10)))); ?>
...
<?php if($video!=null): ?>
 <div class="sidebar-box white featured-video animate-onscroll">
              ...
              <iframe width="560" height="315" src="http://www.youtube.com/embed/<?php echo e($video->url); ?>?wmode=transparent" allowfullscreen></iframe>
              <a href="<?php echo e(URL::to('gallery')); ?>" class="button transparent button-arrow">Visit gallery</a>
    </div>
    <!-- /Featured Video -->
<?php endif; ?>
       
<?php
     $events=\DB::table('events')->orderBy('id', 'desc')->limit(2)->get();
?>
    <!-- Upcoming Events -->
    <div class="sidebar-box white animate-onscroll">
              <h3>Latest Events</h3>
...
<!--     <div class="sidebar-box image-banner animate-onscroll">
      <a href="issues.html">
        <img src="<?php echo e(asset('assets/images/main-issues.jpg')); ?>" alt="">
