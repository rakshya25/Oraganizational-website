...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="<?php echo e(url('')); ?>" class="logo">
      ...
      <span class="logo-mini"><b>FNCN</b></span>
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg"><b>FNCN</b></span>
    </a>
...
<footer class="main-footer">
    <div class="pull-right hidden-xs">
      <b>Powered By:</b> <a href="//psuresh.com.np?ref=FNCN" target="_blank">psuresh.com.np</a>
    </div>
    <strong>Copyright &copy; <?php echo e(date('Y')); ?> <a href="<?php echo e(url('')); ?>">FNCN</a>.</strong> All rights
    reserved.
