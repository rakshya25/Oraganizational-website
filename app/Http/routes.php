...
Route::group(['middleware' => ['web']], function () {
    ...
    Route::get('/sisters', function () {
        return view('front.pages.sisters');
    });
    ...
    Route::get('/affilated-organizations', function () {
        return view('front.pages.affilated-organizations');
    });
    ...
    Route::post('contact', array('uses'=>'Helper@sendContactFormEmail'));
...
Route::get('admin/shops', array('uses' => 'ShopController@showShopList'));
...
Route::get('admin/shops/create', array('uses'=>'ShopController@showCreate'));
Route::post('admin/shops/create', array('uses'=>'ShopController@doCreate'));
...
/*delete routes*/
    ...
    Route::get('admin/shops/delete/{id}', array('uses'=>'ShopController@delete'));
...
Route::get('admin/shops/edit/{id}', array('uses'=>'ShopController@showEdit'));
Route::post('admin/shops/edit/{id}', array('uses'=>'ShopController@doEdit'));
Route::get('admin/shops/status/{id}', array('uses'=>'ShopController@activateDeactivate'));
...
/*/admin approval*/
/*backup database*/
Route::get('admin/backup-full-files-and-database', array('uses'=>'BackupController@fullDownload'))->middleware('auth');

Route::get('admin/change-backup-date', array('uses'=>'BackupController@changeLastBackupDate'))->middleware('auth');
